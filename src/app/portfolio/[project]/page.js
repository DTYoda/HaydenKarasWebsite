    ...
    <div>
        ...
        <div className="w-[100vw] flex flex-col items-center">       
          ...
          <div className="flex w-[100vw] md:w-[80vw] md:h-[40vw] h-[200vw] gap-4 m-4 md:flex-row flex-col">
            <ProjectImages images={images.map(image => "/" + projectData.urlTitle + "/" + image)}/>
          ...
          <div className=" w-[90vw] md:w-[70vw] xl:w-[70vw] grid md:grid-cols-2 grid-cols-1 gap-4">
            ...
            <div>
              ...
              <div className="border-orange-800 border-4  rounded-lg min-h-14 flex justify-center items-center h-20">
                {technologies.map((tech, id) => <Link key={id} title={tech.title} href={tech.link} className=" h-full w-24 flex justify-center items-center"> 
                    <Image src={"/technologyimages/" + tech.title + ".png"} width={100} height={100} style={{ width: '90%', height: 'auto' }}/>
                  </Link>)}
              </div>
            </div>
            ...
            <div> 
              ...
              <div className="border-orange-800 border-4  rounded-lg min-h-14 flex justify-center items-center h-20
              ">
                {links.map((link, id) => <Link key={id} title={link.title} href={link.link} className=" h-full w-24 flex justify-center items-center"> 
                  <Image src={"/linkimages/" + link.title + ".png"} width={100} height={100} style={{ width: '90%', height: 'auto' }}/>
                </Link>)}
              </div>
            </div>
            ...
            <div>
              Date
              <div className="border-orange-800 border-4  rounded-lg min-h-14 h-20">
